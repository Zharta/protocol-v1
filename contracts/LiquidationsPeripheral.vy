...
interface INFTXVaultFactory:
    def vaultsForAsset(assetAddress: address) -> DynArray[address, 2**20]: view
...
def _getNFTXVaultAddrFromCollateralAddr(_collateralAddress: address) -> address:
    ...
    vaultAddrs: DynArray[address, 2**20] = INFTXVaultFactory(self.nftxVaultFactoryAddress).vaultsForAsset(_collateralAddress)
