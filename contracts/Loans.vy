...
interface ICollateralVaultPeripheral:
    def vaultAddress(_collateralAddress: address) -> address: view
    def storeCollateral(_wallet: address, _collateralAddress: address, _tokenId: uint256, _erc20TokenContract: address): nonpayable
