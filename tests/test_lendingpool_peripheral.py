...
def test_deposit_twice(
    ...
    tx_deposit = lending_pool_peripheral_contract.deposit(amount1, {"from": investor})
    ...
    tx_deposit_twice = lending_pool_peripheral_contract.deposit(amount2, {"from": investor})
