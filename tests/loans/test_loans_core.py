...
def test_add_loan(loans_core_contract, loans_peripheral_contract, borrower, contract_owner, test_collaterals):
    ...
    assert checksummed(loans_core_contract.getLoanCollaterals(borrower, loan_id)) == test_collaterals
    ...
    pending_loan_collaterals = checksummed(loans_core_contract.getPendingLoan(borrower, loan_id))[5]
