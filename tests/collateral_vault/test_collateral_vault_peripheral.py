...
def test_claim_ownership(collateral_vault_peripheral_contract, contract_owner, borrower):
    ...
    collateral_vault_peripheral_contract.claimOwnership(sender=borrower)
...
def test_add_loans_peripheral_address(
...
def test_add_loans_peripheral_address_same_address(
    collateral_vault_peripheral_contract,
    loans_peripheral_contract,
    erc20_contract,
    contract_owner
