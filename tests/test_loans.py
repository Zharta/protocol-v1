...
@pytest.fixture
def invpool_contract(InvestmentPool, loans_contract, erc20_contract, contract_owner):
    yield InvestmentPool.deploy(loans_contract.address, erc20_contract, {"from": contract_owner})
