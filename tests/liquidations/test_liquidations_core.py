...
def test_add_loan_to_liquidated(liquidations_core_contract, liquidations_peripheral_contract, loans_core_contract, contract_owner, borrower):
    ...
    liquidations_core_contract.addLoanToLiquidated(borrower, loans_core_contract, 0, sender=liquidations_peripheral_contract.address)
...
def test_remove_liquidation(
    ...
    tx = liquidations_core_contract.removeLiquidation(erc721_contract, 0, sender=liquidations_peripheral_contract.address)
