...
def dev():
    ...
    print(f"liquidity_controls address={liquidity_controls.address}")
...
def prod():
    ...
    loans_peripheral_weth.addCollateralToWhitelist(cryptopunks_instance.address, {"from": owner, "gas_price": web3.toWei(20, "gwei")})
